...
const TABS = [
  {
    ...
    code: index.default['motion-effect-image-grid-demo'].files[0].content,
    demo: index.default['motion-effect-image-grid-demo'].component,
  },
  {
    value: 'components',
    label: 'Components',
    icon: ComponentsIcon,
    name: 'cursor-demo',
    code: index.default['cursor-demo'].files[0].content,
    demo: index.default['cursor-demo'].component,
  },
  {
    value: 'primitives',
    label: 'Primitives',
    ...
    code: index.default['radix-accordion-demo'].files[0].content,
    demo: index.default['radix-accordion-demo'].component,
  },
  {
    value: 'text',
    label: 'Text',
    ...
    code: index.default['writing-text-demo'].files[0].content,
    demo: index.default['writing-text-demo'].component,
  },
  {
    value: 'background',
    label: 'Background',
    ...
    code: index.default['fireworks-background-demo'].files[0].content,
    demo: index.default['fireworks-background-demo'].component,
  },
];
