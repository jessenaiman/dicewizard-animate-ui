    ...
    >
      ...
      <SwitchPrimitives.Thumb
        ...
        render={
          <motion.div
            whileTap="tab"
            className="relative pointer-events-none z-[1] [&_svg]:size-2.5 flex items-center justify-center rounded-full bg-background dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-primary-foreground shadow-lg ring-0 dark:text-neutral-400 text-neutral-500"
            layout
            ...
            animate={
              isTapped
                ...
                : { width: '16px', transition: { duration: 0.1 } }
            }
          />
        }
      >
