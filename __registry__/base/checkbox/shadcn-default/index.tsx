  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        'border-input dark:bg-input/30 data-[checked]:bg-primary data-[checked]:text-primary-foreground dark:data-[checked]:bg-primary data-[checked]:border-primary focus-visible:border-ring aria-invalid:border-destructive size-4 rounded-[4px] border',
        className,
      )}
      {...props}
