...
import {
  ...
  TabsContents,
  type TabsProps,
} from '@/registry/__registry__/components/tabs/shadcn-default';
import { CopyButton } from '@/registry/__registry__/buttons/copy/shadcn-default';
...
function InstallTabs({
  ...
  return (
    ...
    >
      ...
      <TabsContents data-slot="install-tabs-contents" className="h-12">
        {highlightedCommands &&
