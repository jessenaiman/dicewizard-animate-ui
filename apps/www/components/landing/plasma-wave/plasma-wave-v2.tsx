...
// @ts-ignore - ogl types not available
...
export default function PlasmaWaveV2({
  ...
  const startStopApiRef = useRef<StartStopApi>({ start: () => {}, stop: () => {} });
  ...
  }, [isMobile, focalLength, speed1, speed2, dir2, bend1, bend2, pauseWhenOffscreen, rootMargin, dynamicDpr]);
