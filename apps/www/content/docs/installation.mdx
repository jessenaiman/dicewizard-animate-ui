...
### Add @animate-ui in your components.json
...
<Callout type="info">
  **Note:** This step should soon no longer be necessary manually. We have
  submitted a PR to add @animate-ui as a trusted repository. See the [PR
  here](https://github.com/shadcn-ui/ui/pull/8162).
</Callout>
