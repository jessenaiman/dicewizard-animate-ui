...
<CodeTabs
  codes={{
    npm: `npx shadcn@latest add @animate-ui/icons-icon`,
    pnpm: `pnpm dlx shadcn@latest add @animate-ui/icons-icon`,
    yarn: `npx shadcn@latest add @animate-ui/icons-icon`,
    bun: `bun x --bun shadcn@latest add @animate-ui/icons-icon`,
  }}
/>
