...
- New `Flip` primitive.
- New `Liquid` primitive.
- New `Ripple` primitive.
...
Now, all changes will be detailed month by month on this page for greater transparency.
In addition, each time components/primitives are updated, a changelog section will be added to the relevant documentation page.
