...
export const Features = () => {
  return (
    <div className="relative mt-30 py-20 flex flex-col items-center justify-center">
      <MotionEffect
        slide={{
          direction: 'down',
        }}
      ...
      <p className="text-center sm:text-base text-sm text-muted-foreground max-w-md mt-5">
